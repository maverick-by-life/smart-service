...
document.addEventListener("DOMContentLoaded", function(event) {
    ...
    // Function to iterate over nodes and replace img
    ...
    (bodhisvgsInlineSupport = function() {
        ...
        if (ForceInlineSVGActive === 'true') {
            ...
            var allImages = document.getElementsByTagName('img'); // Find all img on page
        ...
        var allImages = document.getElementsByClassName(target); // find all img with force svg class

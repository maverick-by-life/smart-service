	...
	<div id="poststuff">
		...
		<div class="meta-box-sortables ui-sortable">
			...
			<div class="postbox">
				...
				<p>
					<?php esc_html_e( 'When using SVG img on your WordPress site, it can be hard to style elements within the SVG using CSS.', 'svg-support' ); ?>
				...
				<div class="meta-box-sortables ui-sortable">
								...
								<table class="form-table svg-settings">
									...
									<tr valign="top" class="svgs-simple">
										...
										<td>
												...
												<?php esc_html_e( 'Yes', 'svg-support' ); ?><br /><small class="description"><?php esc_html_e('You don\'t need to enable this to simply use SVG files as img. Enabling this will trigger advanced options and SVG functionality such as inline rendering.', 'svg-support' ); ?></small>
											</label>
										</td>
									</tr>
									...
									<tr valign="top" class="svgs-advanced">
										...
										<td>
											<label for="bodhi_svgs_settings[sanitize_svg_front_end]">
												...
												<?php esc_html_e( 'Yes', 'svg-support' ); ?><br /><small class="description"><?php esc_html_e('Enhance security by sanitizing svg img on Front-end. This will help to prevent XSS and Injection attacks.', 'svg-support' ); ?></small>
											</label>
										</td>
									</tr>
					...
					<div class="postbox">
						...
						<div class="inside">
							...
							<p><?php esc_html_e( 'Now that you\'ve set up SVG Support on your site, it\'s time to look at optimizing your existing img (jpg & png).', 'svg-support' ); ?></p>
							<p><?php esc_html_e( 'ShortPixel improves website performance by reducing the size of your img. The results are no different in quality from the original, plus your originals are stored in a backup folder for you.', 'svg-support' ); ?></p>
